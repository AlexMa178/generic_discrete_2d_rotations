...
impl Ray<4> {
    ...
    pub const UP_4   : Self = Self::new(Angle::A4_0  , RotFrom::PosY, RotDir::Clockwise);
    pub const RIGHT_4: Self = Self::new(Angle::A4_90 , RotFrom::PosY, RotDir::Clockwise);
    pub const DOWN_4 : Self = Self::new(Angle::A4_180, RotFrom::PosY, RotDir::Clockwise);
    pub const LEFT_4 : Self = Self::new(Angle::A4_270, RotFrom::PosY, RotDir::Clockwise);

    // inverted y (i.e. y-down such as screen coordinates)
    pub const IY_UP_4   : Self = Self::new(Angle::A4_0  , RotFrom::NegY, RotDir::CounterClockwise);
    pub const IY_RIGHT_4: Self = Self::new(Angle::A4_90 , RotFrom::NegY, RotDir::CounterClockwise);
    pub const IY_DOWN_4 : Self = Self::new(Angle::A4_180, RotFrom::NegY, RotDir::CounterClockwise);
    pub const IY_LEFT_4 : Self = Self::new(Angle::A4_270, RotFrom::NegY, RotDir::CounterClockwise);

}
impl Ray<8> {

    pub const UP_8        : Self = Self::new(Angle::A8_0  , RotFrom::PosY, RotDir::Clockwise);
    pub const UP_RIGHT_8  : Self = Self::new(Angle::A8_45 , RotFrom::PosY, RotDir::Clockwise);
    pub const RIGHT_8     : Self = Self::new(Angle::A8_90 , RotFrom::PosY, RotDir::Clockwise);
    pub const DOWN_RIGHT_8: Self = Self::new(Angle::A8_135, RotFrom::PosY, RotDir::Clockwise);
    pub const DOWN_8      : Self = Self::new(Angle::A8_180, RotFrom::PosY, RotDir::Clockwise);
    pub const DOWN_LEFT_8 : Self = Self::new(Angle::A8_225, RotFrom::PosY, RotDir::Clockwise);
    pub const LEFT_8      : Self = Self::new(Angle::A8_270, RotFrom::PosY, RotDir::Clockwise);
    pub const UP_LEFT_8   : Self = Self::new(Angle::A8_315, RotFrom::PosY, RotDir::Clockwise);

    // inverted y (i.e. y-down such as screen coordinates)
    pub const IY_UP_8        : Self = Self::new(Angle::A8_0  , RotFrom::NegY, RotDir::CounterClockwise);
    pub const IY_UP_RIGHT_8  : Self = Self::new(Angle::A8_45 , RotFrom::NegY, RotDir::CounterClockwise);
    pub const IY_RIGHT_8     : Self = Self::new(Angle::A8_90 , RotFrom::NegY, RotDir::CounterClockwise);
    pub const IY_DOWN_RIGHT_8: Self = Self::new(Angle::A8_135, RotFrom::NegY, RotDir::CounterClockwise);
    pub const IY_DOWN_8      : Self = Self::new(Angle::A8_180, RotFrom::NegY, RotDir::CounterClockwise);
    pub const IY_DOWN_LEFT_8 : Self = Self::new(Angle::A8_225, RotFrom::NegY, RotDir::CounterClockwise);
    pub const IY_LEFT_8      : Self = Self::new(Angle::A8_270, RotFrom::NegY, RotDir::CounterClockwise);
    pub const IY_UP_LEFT_8   : Self = Self::new(Angle::A8_315, RotFrom::NegY, RotDir::CounterClockwise);
